...
class _WidgetBottomSheetState extends State<WidgetBottomSheetRegion> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Text("Viloyatlar",style: TextStyle(fontSize: 17,color: Colors.blue,fontWeight: FontWeight.bold),),
      ),
      SizedBox(height:15 ,),
      Container(
            ...
            builder: (context) {
              if(provider.progress){
                ...
                return ListView.builder(
                  itemCount: provider.resultRegions.length,
                  itemBuilder: (context, index) {
                    return Container(
                      ...
                      child: InkWell(
                        onTap: () {
                          widget.callback?.call(provider.resultRegions[index]);
                          },
                        child: Container(
                          padding: EdgeInsets.only(left: 20, top: 18, bottom: 18),
                          width: double.infinity,
                          child: Text(provider.resultRegions[index].title,
                              style: TextStyle(
                                  fontSize: 15.0,
